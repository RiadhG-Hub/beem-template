...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/tunisian_flag.svg
  SvgGenImage get tunisianFlag =>
      const SvgGenImage('assets/images/tunisian_flag.svg');

  /// List of all assets
  List<dynamic> get values => [iconLogo, img, locationIcon, tunisianFlag];
}
