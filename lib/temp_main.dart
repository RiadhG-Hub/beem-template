...
class _RideBookingPageState extends State<RideBookingPage> {
  ...
  final List<LatLng> _taxiRoute = [
    const LatLng(36.8075, 10.1825), // Starting position
    const LatLng(36.8070, 10.1820),
    const LatLng(36.8065, 10.1815),
    const LatLng(36.8060, 10.1810),
    const LatLng(36.8055, 10.1805),
    const LatLng(36.8050, 10.1800),
    const LatLng(36.8045, 10.1795),
    const LatLng(36.8040, 10.1790),
    const LatLng(36.8035, 10.1785),
    const LatLng(36.8030, 10.1780),
    const LatLng(36.8025, 10.1775),
    const LatLng(36.8020, 10.1770),
    const LatLng(36.8015, 10.1765),
    const LatLng(36.8010, 10.1760),
    const LatLng(36.8005, 10.1755),
    const LatLng(36.8000, 10.1750),
    const LatLng(36.7995, 10.1745),
    const LatLng(36.7990, 10.1740),
    const LatLng(36.7985, 10.1735),
    const LatLng(36.7980, 10.1730),
    const LatLng(36.7975, 10.1725),
    const LatLng(36.7970, 10.1720),
    const LatLng(36.7965, 10.1715),
    const LatLng(36.7960, 10.1710),
    const LatLng(36.7955, 10.1705),
    const LatLng(36.7950, 10.1700),
    const LatLng(36.7945, 10.1695),
    const LatLng(36.7940, 10.1690),
    const LatLng(36.7935, 10.1685),
    const LatLng(36.7930, 10.1680),
    const LatLng(36.7925, 10.1675),
    const LatLng(36.7920, 10.1670),
    const LatLng(36.7915, 10.1665),
    const LatLng(36.7910, 10.1660),
    const LatLng(36.7905, 10.1655),
    const LatLng(36.7900, 10.1650),
    const LatLng(36.7895, 10.1645),
    const LatLng(36.7890, 10.1640),
    const LatLng(36.7885, 10.1635),
    const LatLng(36.7880, 10.1630),
    const LatLng(36.7875, 10.1625),
    const LatLng(36.7870, 10.1620),
    const LatLng(36.7860, 10.1617),
    const LatLng(36.7865, 10.1615),
    const LatLng(36.7860, 10.1610),
  ...
  void _createMarkersAndRoute() {
    ...
    _polylines = {
      Polyline(
        ...
        points: [
          _pickupLocation,
          const LatLng(36.8060, 10.1800),
          const LatLng(36.8020, 10.1750),
          const LatLng(36.8000, 10.1700),
